                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                       ...
                       # 显示编号 自己修改的
                        label = None if hide_labels else (
                            f'{c} {conf:.2f}' if hide_conf else f'{c} {names[c]} {conf:.2f}')
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'D:\\Bishe\\yolov5-7.0\\CBAM_500\\weights\\best.pt', help='model path or triton URL')
