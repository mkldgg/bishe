...
if __name__ == '__main__':
    ...
    file_path = "D:\\Bishe\\P-苹果叶片病害检测2100\\JPEGImages"
    # 定义xml路径变量，指向数据集的标注文件所在路径
    xml_path = "D:\\Bishe\P-苹果叶片病害检测2100\\Annotations"
    # 定义新文件路径变量，指向输出结果文件的新路径
    new_file_path = "D:\\Bishe\\P-苹果叶片病害检测2100\\test"
    # 调用split_data函数，分割数据集，并将结果分别存储到指定的路径中
    split_data(file_path, xml_path, new_file_path, train_rate=0.7, val_rate=0.25, test_rate=0.05)
